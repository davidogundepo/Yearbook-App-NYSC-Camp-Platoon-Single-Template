...
CampCorpersCoordinatorsNotifier campCorpersCoordinatorsNotifier;

class CampCorpersCoordinatorsDetailsPage extends StatefulWidget {

  @override
  _CampCorpersCoordinatorsDetailsPageState createState() => _CampCorpersCoordinatorsDetailsPageState();
}

class _CampCorpersCoordinatorsDetailsPageState extends State<CampCorpersCoordinatorsDetailsPage> {
  ConfettiController _confettiController;

  @override
  Widget build(BuildContext context) {

    campCorpersCoordinatorsNotifier = Provider.of<CampCorpersCoordinatorsNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: campCorpersCoordinatorsNotifier.currentCampCorpersCoordinators.image,
                        fit: BoxFit.cover,
                  ...
                  message: campCorpersCoordinatorsNotifier.currentCampCorpersCoordinators.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(campCorpersCoordinatorsNotifier.currentCampCorpersCoordinators.name.toUpperCase(),
