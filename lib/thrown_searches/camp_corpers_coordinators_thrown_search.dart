...
class MyCampCorpersCoordinatorsSearch extends SearchDelegate {
  final List all;

  MyCampCorpersCoordinatorsSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((campCorpersCoordinators) => campCorpersCoordinators.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((campCorpersCoordinators) => campCorpersCoordinators.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          campCorpersCoordinatorsNotifier.currentCampCorpersCoordinators = search[position];
