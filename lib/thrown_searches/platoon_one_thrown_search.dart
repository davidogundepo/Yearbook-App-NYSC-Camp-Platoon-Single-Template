...
class MyPlatoonOneSearch extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyPlatoonOneSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((platoonOne) => platoonOne.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((platoonOne) => platoonOne.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          platoonOneNotifier.currentPlatoonOne = search[position];
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: <Widget>[
                                          ...
                                          (() {
                                            if (search[position].platoonExecutive == "Yes") {
                                              return
                                                Row(
                                                  children: <Widget>[
                                                    SizedBox(width: 10),
